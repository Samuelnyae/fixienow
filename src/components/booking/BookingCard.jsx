...
import FileDisputeDialog from './FileDisputeDialog';
...
export default function BookingCard({ booking, showTechnician = true, user }) {
  const Icon = iconMap[booking.category] || Wrench;
  const status = statusConfig[booking.status] || statusConfig.pending;
  const [disputeOpen, setDisputeOpen] = useState(false);
  const canDispute = !!user && booking.status !== 'cancelled';
